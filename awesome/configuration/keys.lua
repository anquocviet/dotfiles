...
-- Set Modkey
modkey = "Mod4" 	-- Super Key or Window Key
...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.spawn(string.format("rofi -show run")) end,
    ...
    awful.key({}, "XF86AudioLowerVolume", function ()
        awful.util.spawn("sh -c 'pactl set-sink-mute 0 false ; pactl set-sink-volume 0 -5%'", false) end),
